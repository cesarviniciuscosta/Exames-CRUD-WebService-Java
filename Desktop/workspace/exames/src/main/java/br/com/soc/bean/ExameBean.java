...
public class ExameBean {
	...
	// conversao de objetos para string 
	@Override
	public String toString() {
		return "ExameBean [nome=" + nome + ", cpf=" + cpf + ", idade=" + idade + ", sexo=" + sexo + ", dataNascimento="
				...
				+ ", dataDoExame=" + dataDoExame + ", horaDoExame=" + horaDoExame + ", srNo=" + srNo + ", getNome()="
				+ getNome() + ", getCpf()=" + getCpf() + ", getIdade()=" + getIdade() + ", getSexo()=" + getSexo()
				+ ", getDataNascimento()=" + getDataNascimento() + ", getEmail()=" + getEmail() + ", getTelefone()="
				+ getTelefone() + ", getNomeDoExame()=" + getNomeDoExame() + ", getDataDoExame()=" + getDataDoExame()
				+ ", getHoraDoExame()=" + getHoraDoExame() + ", getSrNo()=" + getSrNo() + ", getClass()=" + getClass()
